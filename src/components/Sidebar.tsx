...
import { PenSquare, CalendarDays, CheckSquare, BookImage, LayoutTemplate, ChevronLeft, ChevronRight, Settings, Users, BarChart3, Sparkles } from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { id: 'nav-composer', label: 'Post Composer', href: '/post-creation-composer', icon: PenSquare, group: 'main' },
  { id: 'nav-ai', label: 'AI Generator', href: '/ai-generator', icon: Sparkles, group: 'main' },
  { id: 'nav-calendar', label: 'Content Calendar', href: '/content-calendar', icon: CalendarDays, group: 'main' },
  { id: 'nav-approval', label: 'Approval Queue', href: '/approval-workflow', icon: CheckSquare, badge: 5, group: 'main' },
  { id: 'nav-library', label: 'Content Library', href: '/content-library', icon: BookImage, group: 'content' },
  { id: 'nav-templates', label: 'Post Templates', href: '/post-templates', icon: LayoutTemplate, group: 'content' },
];
...
export default function Sidebar({ collapsed, onToggle }: SidebarProps) {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className="flex items-center justify-between px-4 py-4 border-b border-border" style={{ height: 'var(--topbar-height)' }}>
      ...
      <div className="px-2 py-3 border-t border-border flex flex-col gap-0.5">
        ...
        {/* User */}
        <div className={`flex items-center gap-2 mt-2 px-2 py-2 rounded-lg hover:bg-muted cursor-pointer transition-colors group relative ${collapsed ? 'justify-center' : ''}`}>
