...
export default function Topbar({ sidebarCollapsed }: TopbarProps) {
  ...
  return (
    ...
    >
      {/* Search */}
      <div className={`flex items-center gap-2 px-3 py-2 rounded-lg border transition-all duration-150 flex-1 max-w-md ${searchFocused ? 'border-primary bg-card shadow-sm' : 'border-border bg-input'}`}>
