...
export const LIBRARY_ITEMS = [
  ...
  },
  {
    id: 'lib-015',
    type: 'carousel',
    title: 'Customer Success Playbook: Reducing Time-to-Value in 14 Days',
    preview:
      'Step-by-step onboarding teardown that cut time-to-first-value from 3 weeks to 4 business days...',
    tags: ['carousel', 'customer-success', 'onboarding'],
    author: 'Sarah Reeves',
    authorInitials: 'SR',
    source: 'composer',
    savedAt: 'Jul 24, 2026',
  ...
  },
  {
    id: 'lib-016',
    type: 'image',
    title: 'Modern Distributed Engineering Setup',
    preview: 'Minimalist workspace and async tooling setup breakdown for remote engineering pods...',
    tags: ['workspace', 'remote-work', 'engineering'],
    author: 'Marcus Chen',
    authorInitials: 'MC',
    source: 'ai_generator',
    savedAt: 'Jul 20, 2026',
    ...
    imageAlt: STOCK_IMAGES.modernWorkspace.label,
    engagementRate: 5.4,
    status: 'published',
  },
  {
    id: 'lib-017',
    type: 'post',
    title: 'Why We Replaced Daily Standups with Asynchronous RFCs',
    preview:
      'Context switching kills deep engineering work. Here is how our 24-hour SLA framework functions in practice...',
    tags: ['culture', 'engineering', 'leadership'],
    author: 'Lisa Tran',
    authorInitials: 'LT',
    source: 'bulk_upload',
    savedAt: 'Jul 16, 2026',
  ...
  },
  {
    id: 'lib-018',
    type: 'infographic',
    title: 'Enterprise PLG vs Sales-Led Funnel Breakdown',
    preview:
      'Side-by-side metric comparison across CAC, payback periods, and expansion velocity for Series B SaaS...',
    tags: ['infographic', 'metrics', 'saas'],
    author: 'Sarah Reeves',
    authorInitials: 'SR',
    source: 'composer',
    savedAt: 'Jul 12, 2026',
  ...
  },
  {
    id: 'lib-019',
    type: 'post',
    title: 'The Single Metric Every Early-Stage B2B Founder Overlooks',
    preview:
      'Net Revenue Retention is a lagging indicator. Here is the leading proxy we track every single Monday...',
    tags: ['thought-leadership', 'growth', 'metrics'],
    author: 'Marcus Chen',
    authorInitials: 'MC',
    source: 'ai_generator',
    savedAt: 'Jul 08, 2026',
