...
const mockPosts: ApprovalPost[] = [
  {
    ...
    revisions: 1,
    comments: [
      { id: 'cmt-001', author: 'Marcus Chen', authorInitials: 'MC', text: 'Love the data points. Can you add the specific tool you switched to? Makes it more concrete.', timestamp: '2026-09-07 15:10', type: 'comment' },
      { id: 'cmt-002', author: 'Lisa Tran', authorInitials: 'LT', text: 'Good point — updated. We use Loom + Notion for async video and docs.', timestamp: '2026-09-07 16:45', type: 'revision_request' },
    ],
  },
  {
    id: 'appr-002',
  ...
  },
  {
    ...
    revisions: 0,
    comments: [
      { id: 'cmt-003', author: 'Jordan Patel', authorInitials: 'JP', text: 'This is great. Approved — schedule for Sep 15 at 9am.', timestamp: '2026-09-06 14:20', type: 'approval' },
    ],
  },
  {
    id: 'appr-004',
    ...
    revisions: 2,
    comments: [
      { id: 'cmt-004', author: 'Sarah Reeves', authorInitials: 'SR', text: 'The ARR figure shouldn\'t be public yet — we haven\'t announced it. Please remove and resubmit.', timestamp: '2026-09-05 17:45', type: 'revision_request' },
      { id: 'cmt-005', author: 'Jordan Patel', authorInitials: 'JP', text: 'Understood — removed the ARR mention. Resubmitting.', timestamp: '2026-09-06 09:10', type: 'comment' },
      { id: 'cmt-006', author: 'Sarah Reeves', authorInitials: 'SR', text: 'Still references the Q4 analytics integration — that timeline isn\'t confirmed. Rejecting for now — please align with product team first.', timestamp: '2026-09-06 10:30', type: 'rejection' },
    ],
  },
  {
    id: 'appr-005',
...
export default function ApprovalShell() {
  const [posts, setPosts] = useState<ApprovalPost[]>(mockPosts);
  const [selectedId, setSelectedId] = useState<string>(mockPosts[0].id);
