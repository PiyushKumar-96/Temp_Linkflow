...
const DEFAULT_QUOTES = [
  ...
  { text: 'A clear process beats a last-minute scramble.', note: 'Your queue is doing the heavy lifting.' },
  { text: 'Ship the draft, then make it better.', note: 'Momentum matters more than polish.' },
  { text: 'Your calendar is a promise to your audience.', note: 'Keep the promise, one slot at a time.' },
];
...
export default function DashboardQuoteCard({ quotes = DEFAULT_QUOTES }) {
  ...
  return (
    <Panel as="figure" className="relative flex items-start gap-3.5 overflow-hidden p-5">
      <Quote size={30} strokeWidth={0} aria-hidden="true" className="shrink-0 -scale-x-100 fill-primary" />
