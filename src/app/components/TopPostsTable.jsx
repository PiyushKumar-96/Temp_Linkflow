...
const posts = [
  ...
  },
  {
    id: 'post-004',
    excerpt:
      "We're hiring a Senior Product Designer to join our distributed team. Here's why we're different...",
    author: 'Jordan Patel',
    authorInitials: 'JP',
    publishedDate: 'Aug 27',
    impressions: 16200,
    reactions: 390,
    comments: 88,
    reposts: 22,
  ...
  },
  {
    id: 'post-005',
    excerpt:
      "Join us at SaaStr Annual next week — we'll be at booth 412. Come say hi and grab a demo...",
    author: 'Lisa Tran',
    authorInitials: 'LT',
  ...
  {
    id: 'post-006',
    excerpt: "What's the biggest mistake companies make with LinkedIn? Drop your answer below...",
    author: 'Marcus Chen',
    authorInitials: 'MC',
    publishedDate: 'Aug 21',
    impressions: 21300,
    reactions: 720,
    comments: 203,
    reposts: 56,
  ...
  },
  {
    id: 'post-008',
    excerpt:
      "Our Q2 product roadmap is live — transparency is a core value here. Here's what we're building...",
    author: 'Jordan Patel',
    authorInitials: 'JP',
    publishedDate: 'Aug 15',
    impressions: 9200,
    reactions: 201,
    comments: 34,
    reposts: 14,
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-border bg-muted/40">
              <th className="text-left px-5 py-2.5 text-xs font-600 text-muted-foreground uppercase tracking-wide">
                Post
              </th>
              ...
              >
                ...
                <td className="px-3 py-3.5">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span
                      className={`text-sm font-600 tabular-nums ${post.trend === 'up' ? 'text-success' : 'text-danger'}`}
                    >
                      {post.engRate}%
                    </span>
                  </div>
