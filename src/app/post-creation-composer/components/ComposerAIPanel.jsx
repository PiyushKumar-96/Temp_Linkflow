...
const toneSuggestions = [
  {
    tone: 'professional',
    preview: "We're excited to announce that our platform has reached a significant milestone...",
  },
  {
    tone: 'conversational',
    preview:
      "Can I be honest with you? Most LinkedIn advice is completely wrong. Here's what actually works...",
  },
  {
    tone: 'inspirational',
    preview:
      'Three years ago we had zero customers. Today we serve 10,000 teams. The lesson? Just start.',
  },
  {
    tone: 'educational',
    preview:
      'Here are the 5 LinkedIn metrics that actually predict pipeline growth (and how to track them)...',
  },
];
...
export default function ComposerAIPanel({
  ...
  const [openSection, setOpenSection] = useState('hashtags');
      ...
      >
        ...
        {!content && (
          <p className="text-xs text-muted-foreground mt-2 text-center">
            Write or generate a post first
          </p>
        )}
      </Section>
    </div>
